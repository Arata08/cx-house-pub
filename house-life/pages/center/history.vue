	...
	<view>
		...
		<u-navbar :is-back="true" title="浏览记录" :border-bottom="false">
			<view class="u-nav-slot" slot="right" @click="clearHistory">
				<u-icon name="trash" style="margin-left: 5rpx;"></u-icon>
				<text>清除</text>
			</view>
		</u-navbar>
		<!-- #endif -->
		<!-- #ifdef MP-TOUTIAO -->
		<view class="u-nav-slot" slot="right" @click="clearHistory" style="margin-left: 45%;margin-top: 10px;">
			<u-icon name="trash" style="margin-left: 5rpx;"></u-icon>
			<text>清除</text>
		</view>
		<!-- #endif -->
